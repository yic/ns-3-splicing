...
set style line 2 lt 1 lw 2 pt 2 ps 1.5 lc rgb "blue"
...
set origin 0,0.5
set xlabel 'Path Stretch with 1% Link Failure Probability' font "Helvetica, 20"
plot [1:4]\
...
set origin 0,0
set xlabel 'Path Stretch with 10% Link Failure Probability' font "Helvetica, 20"
plot [1:4]\
