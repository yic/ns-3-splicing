...
'sprint-failure-reliability.dat' using ($1 * 100):($8 * 100) title '' with line ls 6,\
'sprint-failure-reliability-point2.dat' using ($1 * 100):($8 * 100) title 'Perfect Switching' with linespoints ls 6
