...
set output 'sprint-blackhole-retx.eps'
set border 3 front linetype -1 linewidth 1.000
set boxwidth 1.0 absolute
set style fill solid 1.00 border -1.0
set grid nopolar
...
set key noinvert samplen 4 spacing 3 width 3 height 0 font "Helvetica, 20"
...
plot 'sprint-blackhole-retx.dat' using 2 ti col lt -1 lc rgb "gray", '' using 3 ti col lt -1 lc rgb "white"
