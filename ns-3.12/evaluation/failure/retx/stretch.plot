...
#'stretch-5-20-0.01' using ($1):($0 / $2 * 100) title 'slice=5, retx=20, prob=0.01' with line ls 2,\
#'stretch-5-20-0.05' using ($1):($0 / $2 * 100) title 'slice=5, retx=20, prob=0.05' with line ls 4,\
#'stretch-5-20-0.1' using ($1):($0 / $2 * 100) title 'slice=5, retx=20, prob=0.1' with line ls 6
